#!/usr/bin/env python3
"""Run a threaded simulation for the ECroA scheme."""
...
def main():
    ...
    parser.add_argument("--devices", type=int, default=8, help="Number of DT actors.")
    parser.add_argument("--messages", type=int, default=16, help="Number of cross-domain messages to submit.")
    parser.add_argument("--domains", type=int, default=3, help="Number of MEC/security domains.")
    parser.add_argument(
        "--security-model",
        default="128",
        choices=["80", "112", "128"],
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="If >=0, tamper one queued packet to trigger per-domain fallback verification.",
    )
    ...
    def _single_run(_idx: int):
        ...
        payload = run_threaded_ecroa_demo(
