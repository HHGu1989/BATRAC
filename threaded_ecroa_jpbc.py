#!/usr/bin/env python3
"""Python wrapper for the real JPBC-based ECroA threaded runner."""
...
JAVA_DIR = ROOT / "ecroa-java"
JAVA_FILE = JAVA_DIR / "ECroAThreadedRunner.java"
CLASS_FILE = JAVA_DIR / "ECroAThreadedRunner.class"
