#!/usr/bin/env python3
"""Run a threaded simulation for the Shen V2G scheme."""
...
def main():
    ...
    parser.add_argument("--devices", type=int, default=8, help="Number of EV actors.")
    parser.add_argument("--messages", type=int, default=16, help="Number of signed EV messages to submit.")
    parser.add_argument(
        "--security-model",
        default="128",
        choices=["80", "112", "128"],
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="If >=0, tamper one queued signature to trigger invalid signature tracking.",
    )
    ...
    def _single_run(_idx: int):
        ...
        payload = run_threaded_shen_demo(
